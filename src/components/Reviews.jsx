      ...
      {reviews ? (
        reviews.map((item) => (
          <div key={item.id}>
            ...
            <div className="w-auto h-auto  p-6 flex flex-row items-center">
              <img
                className="w-[50px] h-[50px] rounded-full object-cover m-2 relative "
                src={
                ...
                alt=""
              />
              <h3 className=" text-sm sm:text-base font-medium px-6 text-white text-center">
                {item.author}
              </h3>
            </div>
