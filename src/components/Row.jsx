...
export default function Row({ title, fetchUrl, rowId }) {
    ...
    return (
        <div className='md:mt-8'>
            <h2 className="text-gray-100 text-center font-bold text-xl md:text-4xl p-8 md:mx-20 my-6 md:my-10"> <span className='px-6 md:px-10 py-2 '>{title}</span></h2>
            <div className="relative flex items-center group ">
                ...
                <div id={'slider' + rowId} className='w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative'>
                    {movies.map((item, id) => (
                        <div key={item.id} className='w-[240px] sm:w-[240px] lg:w-[280px] h-96] p-2 md:p-6 inline-block cursor-pointer relative transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300'>
