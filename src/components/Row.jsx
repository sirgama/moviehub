        ...
        <div className='md:mt-8'>
            ...
            <div className="relative flex items-center group ">
                ...
                <div id={'slider' + rowId} className='w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative'>
                    {movies.map((item, id) => (
                        <Link to={`/movie/${item.id}`}><div key={item.id} className='w-[240px] sm:w-[240px] lg:w-[280px] h-96] p-6 md:p-6 inline-block cursor-pointer relative transition ease-in-out delay-300 hover:-translate-y-1 hover:scale-110 duration-500'>
