        ...
        <div className="absolute top-[10%] md:top-[20%] p-5 m-5 flex flex-row flex-wrap sm:flex-nowrap">
          <div>
            <div className="w-[240px] sm:w-[240px] lg:w-[280px] h-96 inline-block cursor-pointer relative p-3">
              <img
                className="w-auto h-full block bg-cover bg-center rounded-lg shadow-3xl"
          ...
          <div className="md:mx-20 md:px-10">
            ...
            <div className="my-4">
              <button className="text-black border bg-pink-300 px-5 py-1">
                Play
              </button>
              <button className="text-white   px-5 py-2 ml-4 font-medium">
                Read more ...
              </button>
            </div>
            <p className="text-gray-400 text-sm">
              Release date:{" "}
              <span className="font-bold">{singleMovie?.release_date}</span>
            </p>
