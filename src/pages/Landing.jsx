  ...
  return (
    <div className="w-full h-full ">
      ...
      <div className="w-full p-5  ">
        <div className="w-full md:w-2/3  mx-auto">
          <div className="flex justify-between md:my-6">
            <h3 className=" text-white text-sm md:text-xl font-bold  decoration-indigo-500">
              Well curated movies
            </h3>
            <a href="/home">
              <h6 className="text-white text-sm md:text-xl font-bold underline decoration-indigo-500">
                See all
              </h6>
            </a>
          </div>
      ...
      <div className="text-white w-full bg-gradient-to-r ">
        <h1 className="text-4xl text-center p-5 my-8 font-bold ">
          Immersive <br />{" "}
          <span className="underline decoration-sky-500">Experience</span>{" "}
        </h1>
        <div className="flex flex-wrap justify-around md:flex-nowrap w-5/6 mx-auto">
          <div className="flex flex-col  p-6 md:p-1 m-10">
            <h3 className="text-4xl text-center font-bold text-cyan-200">
              800+
            </h3>
            <h5 className="text-base my-4 font-bold">Movies and tv shows</h5>
          </div>
          <div className="flex flex-col p-6 md:p-1 m-10">
            <h3 className="text-4xl text-center font-bold text-emerald-200">
              16k+
            </h3>
          ...
          <div className="flex flex-col  p-6 md:p-1  m-10">
            ...
            <h5 className="text-base my-4 text-center font-bold">
              Well organized movie categorization
            </h5>
          </div>
        </div>
      </div>
      <div className="w-full relative">
        <h1 className="text-center my-10 p-4 text-3xl md:text-4xl font-bold text-cyan-200 ">
          {" "}
          <span className="border-t-4 border-b-4 py-2 px-6 border-l-zinc-500 border-b-pink-500 border-t-sky-500">
            Coming Soon
          </span>
        </h1>
      ...
      <div className="w-full text-white text-center">
        <div className="my-20">
          <h2 className="text-4xl font-bold py-2 mt-20 mb-9">
            Love to get updates?
          </h2>
          <p className="text-sm text-gray-400">
            Subscribe to get new updates on movies and content straight to your
            inbox. No Spam! No Ads!
          </p>

          <div className="my-16">
            <form action="" className="">
              <input
                className="bg-black border-2 rounded-tl text-white rounded-bl border-pink-500 py-3 px-7 md:px-20"
                type="email"
                name=""
                id=""
                placeholder="Enter your Email"
              />
              <button className="py-3 bg-pink-500 px-4 md:px-10 rounded-tr rounded-br border-2 border-pink-500">
                Subscribe
              </button>
            </form>
          </div>
