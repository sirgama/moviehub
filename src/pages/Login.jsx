            ...
            <div className="flex-1">
              ...
              <div className="mt-8">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mt-6">
                    <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-pink-500 rounded-md hover:bg-pink-400 focus:outline-none focus:bg-pink-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                      Sign in
                    </button>
                  </div>
                </form>
