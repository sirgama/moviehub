...
export default function Signup() {
  ...
  return (
    ...
    <div className='w-full h-screen '>
      <img className='hidden sm:block absolute w-full h-full object-cover' src="https://images.hdqwalls.com/download/the-lion-king-2019-scar-ll-1920x1080.jpg" alt="heroimage" />
        <div className="bg-black/60 fixed top-0 left-0 w-full h-screen "></div>
        <div className="fixed w-full px-4 py-16 z-50">
            <div className="max-w-[450px] h-[600px] mx-auto bg-black/75 text-white">
            
                <div className="max-w-[320px] mx-auto py-8">
                {errorr && <div className=" p-4 mb-4 text-sm text-yellow-700 bg-yellow-100 rounded-lg dark:bg-yellow-200 dark:text-yellow-800" role="alert">
                ...
                <img
                  ...
                  />Create account
                    ...
                    <form onSubmit={handleSubmit} action="" className='w-full flex flex-col py-4'>
                        ...
                        <button type="submit" className='bg-pink-500 px-6 py-3 rounded text-gray-30 my-6 font-semibold'>Create account</button>
                        <div className='flex justify-between items-center text-sm text-gray-500'>
                            <p><input type="checkbox" name="" id="" /> Remember me</p>
                            <p></p>
                        </div>
                        <p className='py-9'><span className='text-gray-500 text-sm mx-1'>Already have an account?</span>
                        <Link to='/login'>
                         Sign in
                        </Link>
                        </p>
